  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    ...
    .bg-image {
        ...
        background-image: url('../../public/img/gedung_jti.jpg');
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3 ">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">E-Pustaka</h5>
                    <p class="text-center small">Silahkan Login</p>
                  </div>

                  <form class="row g-3 needs-validation" method="POST" action="../controllers/cek_login.php" novalidate>
                  <?php
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" pattern="[0-9]*" inputmode="numeric" name="no_induk" class="form-control" id="no_induk" placeholder="NIP or NIM" required>
                        <div class="invalid-feedback">Please enter your NIM or NIP.</div>
                      </div>
                    </div>
                    ...
                    <!-- <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="#">Sign Up</a></p>
                    </div> -->
                  </form>
              ...
              <div class="credits bg-white">
                ...
                Designed by <a href="https://bootstrapmade.com/">SumberRejeki</a>
              </div>
